=========================================================
Oracle RAC 19c 3 Node + ASM (ByteW@rks)
=========================================================
...
(hasil tidak boleh minta password)
...
- IP tiap node HARUS berbeda
- /etc/hosts HARUS sama
- SSH wajib tanpa password
- Disk ASM HARUS shared
- Private network HARUS benar
- SCAN 1 IP cukup untuk LAB
