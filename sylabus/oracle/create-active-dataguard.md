...
```ini
orapwd file=$ORACLE_HOME/dbs/orapwbyteworks password=We1come# force=y
scp orapwbyteworks oracle@192.168.56.50:$ORACLE_HOME/dbs
```
...
CONNECT IDENTIFIER IS BYTEWORKS;

ADD DATABASE byteworks_drc
AS CONNECT IDENTIFIER IS BYTEWORKS_STANDBY
MAINTAINED AS PHYSICAL;

ENABLE CONFIGURATION;
ENABLE DATABASE byteworks_drc;
```
...
```sql
EDIT DATABASE byteworks_drc SET STATE=APPLY-ON;
EDIT DATABASE byteworks_drc SET STATE=APPLY-OFF;
```
...
EDIT DATABASE byteworks_drc SET PROPERTY LogXptMode='SYNC';

EDIT DATABASE byteworks SET PROPERTY Binding='MANDATORY';
EDIT DATABASE byteworks_drc SET PROPERTY Binding='MANDATORY';

EDIT DATABASE byteworks SET PROPERTY FastStartFailoverTarget='byteworks_drc';
EDIT DATABASE byteworks_drc SET PROPERTY FastStartFailoverTarget='byteworks';
